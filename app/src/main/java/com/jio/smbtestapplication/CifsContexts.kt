...
object CifsContexts {
    ...
    private val TAG = "jashwant_CifsContents"
    ...
    fun createWithDisableIpcSigningCheck(
        ...
        Log.d(TAG, "createWithDisableIpcSigningCheck: ")
    ...
    fun create(basePath: String, extraProperties: Properties?): BaseContext {
        Log.d(TAG, "create: basepath-"+basePath)
        Log.d(TAG, "create: extraproperties"+extraProperties)
